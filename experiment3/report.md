...
| 算法            |  sample_4a    | le450_5a | le450_15b | le450_25a |
|-----------------|--------------|-----------|-----------|----------|
| 朴素暴力         |   0.182ms   | TLE   | TLE      | TLE      |
| 可行性剪枝       |   0.001ms  |  TLE   | TLE     | TLE      |
| 度数优化         |  0.002ms  | TLE     | TLE     | 0.143      |
| 向前探测        | 0.002ms  | TLE     | TLE     | 0.116    |
| 最少颜色优先选择  | 0.054 | 92.432ms     | TLE     | 0.448    |
| 对称性优化       |  0.003ms |   94.993ms   | TLE     | 0.433    |
...
|--------------|--------|--------|--------|--------|--------|
| Time         | 0.158  | 0.297  | 0.285  | 0.547  | 0.752  |

作图得到以下的图：

<!-- 使用word完成折线图 -->

实测数据波增长趋势呈现指数级变化，符合其时间复杂度模型 $O(kn)$，$k$ 为颜色数，$n$ 为顶点数。
